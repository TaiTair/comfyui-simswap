...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument("--Arc_path", type=str, default=simswap_checkpoints_path+'/arcface_checkpoint.tar', help="run ONNX model via TRT")
        ...
        self.parser.add_argument('--no_simswaplogo', default=1, action='store_true', help='Remove the watermark')
