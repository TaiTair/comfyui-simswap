...
class BaseOptions():
    ...
    def initialize(self):
        ...
        simswap_checkpoints_path = os.path.join(models_path, "simswap")
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default=simswap_checkpoints_path, help='models are saved here')
        #self.parser.add_argument('--checkpoints_dir', type=str, default='/opt/comfyui/models/simswap', help='models are saved here')
